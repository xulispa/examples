...
(function ($) {
  appear = function () {
    ...
    var n = null, i = 0, o = {};
    return addEventListener("scroll", e, !1), function (e) {
      return function (e) {
        function n(e, t) {
          return function () {
        ...
        return function (e) {
          e = e || {}, y = {
            ...
            delta: {speed: e.deltaSpeed || 50, timeout: e.deltaTimeout || 500}
...
$(function () {
  var element = $('body, #page, section#content, #navigation');
