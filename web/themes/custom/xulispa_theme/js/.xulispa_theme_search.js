...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.lunrSearchPage.prototype.init = function() {
    this.$form.on('submit', function(e) {
      e.preventDefault();
      var value = this.$form.find('.js-form-item-search, .js-lunr-search-input').val();
      var parameters = {
        search: value,
        page: 1
      };
      this.$form.find('[data-drupal-form-fields], [data-lunr-search-field]').each(function () {
        parameters[$(this).attr('data-drupal-form-fields, data-lunr-search-field')] = $(this).val();
      });
  ...
  Drupal.lunrSearchPage.prototype.searchByQuery = function() {
    ...
    for (var key in parameters) {
      if (key !== 'search' && key !== 'page') {
        ...
        this.$form.find('[data-drupal-form-fields="' + key + '"]').val(parameters[key]);
      }
    }
    if (Object.keys(parameters).length) {
      var search = parameters['search'] ? parameters['search'] : '';
      this.$form.find('.js-form-item-search, .js-lunr-search-input').val(search);
      this.showProgress();
  ...
  Drupal.behaviors.lunrIndexForm = {
    attach: function(context) {
      $('form.js-lunr-search-block-form, form.js-lunr-search-page-form', context).once('lunr-search').each(function() {
