...
'ecultura_theme' are renamed to guarantee a proper working theme. ecultura_theme itself
...
libraries with the ecultura_theme variant. This means there is a relation between
