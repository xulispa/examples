      ...
      return {
        ...
        prototype: {
          ...
          mapDialogOptions: function(options) {
            ...
            // Handle deprecated "dialogClass" option by merging it with
            // "classes".
            var classesMap = {
            ...
            // Bind events.
            var events = ['beforeClose', 'close', 'create', 'drag', 'dragStart', 'dragStop', 'focus', 'open', 'resize', 'resizeStart', 'resizeStop'];
            for (i = 0,
            ...
            for (var name in dialogOptions) {
              if (!dialogOptions.hasOwnProperty(name) || dialogOptions[name] === void 0) {
                continue;
              }
    ...
    $.extend(Drupal.theme, /** @lend Drupal.theme */
    {
      ...
      bootstrapModalDialogButton: function(button) {
        ...
        // @todo Map jQuery UI icons to Bootstrap icons?
          ...
          var iconAttributes = Attributes.create().addClass(['ui-icon', button.icon]).set('aria-hidden', 'true');
